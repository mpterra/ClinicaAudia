...
public class CompraProdutoPanel extends JPanel {
    ...
    private JPanel criarPainelFormulario() {
        ...
        txtFornecedor.setPreferredSize(new Dimension(150, 25));
        txtFornecedor.setFont(fieldFont);
        gbcData.gridx = 1;
        gbcData.weightx = 1.0;
        dataPanel.add(txtFornecedor, gbcData);
        ...
        botoesPanel.add(btnRealizarCompra);
    ...
    private void realizarCompra() {
        try {
            ...
            if (fornecedor.isEmpty()) {
                throw new IllegalArgumentException("O campo fornecedor é obrigatório!");
            }
            int parcelas = (Integer) spinnerParcelas.getValue();
            String metodo = (String) cbMetodoPagamento.getSelectedItem();

            Caixa caixa = caixaController.getCaixaAberto();
            if (caixa == null && ("DINHEIRO".equals(metodo) || "PIX".equals(metodo) || "DEBITO".equals(metodo) || parcelas == 1)) {
            ...
            BigDecimal valorParcela = valorTotalCompra.divide(BigDecimal.valueOf(parcelas), 2, BigDecimal.ROUND_HALF_UP);
            for (int i = 1; i <= parcelas; i++) {
                ...
                pagamento.setStatus(i == 1 && ("DINHEIRO".equals(metodo) || "PIX".equals(metodo) || "DEBITO".equals(metodo)) ? PagamentoCompra.StatusPagamento.PAGO : PagamentoCompra.StatusPagamento.PENDENTE);
                ...
                if (i == 1 && ("DINHEIRO".equals(metodo) || "PIX".equals(metodo) || "DEBITO".equals(metodo) || parcelas == 1)) {
                    ...
                    movimentoCaixa.setDescricao("Pagamento " + (parcelas == 1 ? "à vista" : "parcela " + i + "/" + parcelas) + " de compra ID " + compraId);
