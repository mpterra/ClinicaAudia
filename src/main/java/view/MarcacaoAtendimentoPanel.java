...
public class MarcacaoAtendimentoPanel extends JPanel {
	...
	private final Color backgroundColor = new Color(245, 245, 245); // Cor única para todos os elementos
	...
	public MarcacaoAtendimentoPanel() {
		...
		// garante que ao redimensionar fique meio a meio
		splitPane.setResizeWeight(0.5);

		// garante que ao abrir a tela o divisor inicie no meio
