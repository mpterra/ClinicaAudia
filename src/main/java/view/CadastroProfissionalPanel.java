...
public class CadastroProfissionalPanel extends JPanel {
	...
	private JPanel criarPainelCadastro() {
		...
		panelProfissional.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.BLACK),
				"Cadastrar novo profissional", TitledBorder.LEADING, TitledBorder.TOP));
		...
		panelEndereco.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.BLACK),
				"Endereço", TitledBorder.LEADING, TitledBorder.TOP));
	...
	private JFormattedTextField criarCampoFormatado(JPanel panel, String label, int y, String mask, int columns,
